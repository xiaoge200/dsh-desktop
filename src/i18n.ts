...
export const SETTINGS_STRINGS = {
  zh: {
    ...
    "更新预发布版本": "更新预发布版本",
    "更新预发布版本提示": "开启后检查与自动更新也包含预发布版本（如 beta / rc）",
    "服务": "服务",
    "本地服务": "本地服务",
    "正在检查…": "正在检查…",
    "重启服务": "重启服务",
  ...
  en: {
    ...
    "更新预发布版本": "Include prerelease builds",
    "更新预发布版本提示": "When enabled, checks and auto-updates also include prerelease builds (e.g. beta / rc)",
    "服务": "Service",
    "本地服务": "Local service",
    "正在检查…": "Checking…",
